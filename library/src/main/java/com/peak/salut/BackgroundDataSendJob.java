...
//            dataStreamToOtherDevice.write(dataToSend.getBytes());

            OutputStream dataStreamToOtherDevice = new BufferedOutputStream(dataSocket.getOutputStream());
            dataStreamToOtherDevice.write(data.toString().getBytes());
